...
export default {
  ...
  billingSuccessPage: {
    ...
    thankYou:
      "Thank you for trusting Ara OS. Your successful journey towards building and maintaining a SaaS product starts now!",
  },
  contactSales: {
    company: "Company",
  ...
  pricingPage: {
    pageDescription: "Choose the plan that fits your needs.",
    pageTitle: "Pricing",
